...
public class ReadTransactionExcel {
    ...
    private static void printHeader(){
        System.out.format("%-20s %-15s %-15s %-35s %-15s\n",
                "Transaction Type", "Account", "Amount", "Message", "Date Time");
    }
            ...
            while (cellIterator.hasNext()) {
                ...
                switch (columnIndex) {
                    ...
                    case COLUMN_INDEX_ACCOUNT:
                        transaction.setAccount((Double) getCellValue(cell));
                        break;
                    ...
                    case COLUMN_INDEX_DATE:
                        ...
                        transaction.setDate(sdf.format(cell.getDateCellValue()));
                        break;
                    default:
                        break;
                }
