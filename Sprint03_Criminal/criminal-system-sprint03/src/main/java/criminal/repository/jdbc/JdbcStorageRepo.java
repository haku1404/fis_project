...
import criminal.model.mapper.StorageRowMapper;
import criminal.repository.StorageRepo;
...
@Repository
public class JdbcStorageRepo extends
        JdbcAbstractRepo<Storage> implements StorageRepo {
